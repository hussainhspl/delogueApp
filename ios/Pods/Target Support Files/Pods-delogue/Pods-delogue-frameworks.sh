...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNBootSplash/RNBootSplash.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-appearance/react_native_appearance.framework"

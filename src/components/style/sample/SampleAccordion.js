...
import {View, Text, TouchableOpacity, Image, Dimensions, TouchableHighlight, StyleSheet} from 'react-native';
...
class SampleAccordion extends React.Component {
  ...
  _renderContent = section => {
    ...
    return (
      <View style={styles.content}>
        {/* <Text>{section.content}</Text> */}
				{ section.content == 1 && (<Text>text 1</Text>)}		
				{ section.content == 2 && (<Text>text 2</Text>)}		
				{ section.content == 3 && (<Text>text 3</Text>)}		
				{ section.content == 4 && (<Text>text 4</Text>)}		
				{ section.content == 5 && (<Text>text 5</Text>)}		
				{ section.content == 6 && (<Text>text 6</Text>)}		
				{ section.content == 7 && (<Text>text 7</Text>)}		
      </View>
    );
  };
